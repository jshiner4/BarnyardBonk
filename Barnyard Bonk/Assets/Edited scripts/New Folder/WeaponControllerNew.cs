...
public class WeaponControllerNew : MonoBehaviour
{
    ...
    public ProjectileBaseNew projectilePrefab;
    ...
    void HandleShoot()
    {
        ...
        for (int i = 0; i < bulletsPerShotFinal; i++)
        {
            ...
            ProjectileBaseNew newProjectile = Instantiate(projectilePrefab, weaponMuzzle.position, Quaternion.LookRotation(shotDirection));

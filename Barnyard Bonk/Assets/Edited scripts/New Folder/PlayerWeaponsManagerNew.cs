...
public class PlayerWeaponsManagerNew : MonoBehaviour
{
    ...
    public List<WeaponControllerNew> startingWeapons = new List<WeaponControllerNew>();
    ...
    public UnityAction<WeaponControllerNew> onSwitchedToWeapon;
    public UnityAction<WeaponControllerNew, int> onAddedWeapon;
    public UnityAction<WeaponControllerNew, int> onRemovedWeapon;

    WeaponControllerNew[] m_WeaponSlots = new WeaponControllerNew[9]; // 9 available weapon slots
    ...
    {
        // shoot handling
        WeaponControllerNew activeWeapon = GetActiveWeapon();
    ...
    public void SwitchToWeaponIndex(int newWeaponIndex, bool force = false)
    {
        if (force || (newWeaponIndex != activeWeaponIndex && newWeaponIndex >= 0))
        {
            ...
            if (GetActiveWeapon() == null)
            {
                ...
                WeaponControllerNew newWeapon = GetWeaponAtSlotIndex(m_WeaponSwitchNewWeaponIndex);
    ...
    public bool HasWeapon(WeaponControllerNew weaponPrefab)
    {
    ...
    void UpdateWeaponSwitching()
    {
        ...
        if (switchingTimeFactor >= 1f)
        {
            if (m_WeaponSwitchState == WeaponSwitchState.PutDownPrevious)
            {
                ...
                WeaponControllerNew oldWeapon = GetWeaponAtSlotIndex(activeWeaponIndex);
                if (oldWeapon != null)
                {
                ...
                // Activate new weapon
                WeaponControllerNew newWeapon = GetWeaponAtSlotIndex(activeWeaponIndex);
                if (onSwitchedToWeapon != null)
                {
                    onSwitchedToWeapon.Invoke(newWeapon);
                }
    ...
    public bool AddWeapon(WeaponControllerNew weaponPrefab)
    {
        ...
        for (int i = 0; i < m_WeaponSlots.Length; i++)
        {
            ...
            if (m_WeaponSlots[i] == null)
            {
                ...
                WeaponControllerNew weaponInstance = Instantiate(weaponPrefab, weaponParentSocket);
    ...
    public bool RemoveWeapon(WeaponControllerNew weaponInstance)
    {
    ...
    public WeaponControllerNew GetActiveWeapon()
    {
        return GetWeaponAtSlotIndex(activeWeaponIndex);
    }

    public WeaponControllerNew GetWeaponAtSlotIndex(int index)
    {
    ...
    void OnWeaponSwitched(WeaponControllerNew newWeapon)
    {
        if (newWeapon != null)
        {
